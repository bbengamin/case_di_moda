...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', sort_order = '" . (int)$data['sort_order'] . "', text = '" . $this->db->escape($data['text']) . "'");
	...
	public function editManufacturer($manufacturer_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', text = '" . $this->db->escape($data['text']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
